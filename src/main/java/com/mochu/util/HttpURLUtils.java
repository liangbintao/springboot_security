...
public final class HttpURLUtils {
	...
	/**
	 * 无视证书 参考地址 http://li3huo.com/2009/09/https-certificates-are-ignoring-the-right
	 * -java-http-client/
	 * 
	 * @param reqUrl
	 * @param parameters
	...
	private static HttpsURLConnection sendPostHttps(String reqUrl, Map<String, String> parameters) {
		...
		try {
			...
			// .setRequestProperty(
			// "User-Agent",
			// "Mozilla/5.0 (Windows; U; Windows NT 6.1; zh-CN; rv:1.9.2.3) Gecko/20100401
			// Firefox/3.6.3");
	...
	public static String doGet(String link, String charset) {
		...
		try {
			...
			System.out.println("doGet link " + link);
			e.printStackTrace();
	...
	public static String doGetWithCookie(String link, String cookie) {
		BufferedInputStream in = null;
		ByteArrayOutputStream out = null;
		try {
			URL url = new URL(link);
			...
			conn.setRequestProperty("X-DevTools-Emulate-Network-Conditions-Client-Id",
					"2BFD44019F86FC4ED9F732BAC47BCEFD");
